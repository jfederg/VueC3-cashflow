...
<script setup>
//composition API points="0,0 100,100 200,100 300,200"
...
const amountToPixels = (amount) => {
	...
	const mintomax = Math.abs(max) + Math.abs(min);

	return 200 - ((amountAbs * 100)/ mintomax) * 2;
}
